...
public class ProfileCache {
    ...
    public Optional<TextureResult> texture(UUID larpUid) {
        ...
        MinecraftProfileTextures textures = MinecraftClient.getInstance().getSessionService().getTextures(new GameProfile(larpUid, "a user"));
        this.textureMap.put(larpUid, new TextureResult(MinecraftProfileTexture.Type.SKIN, textures.skin()));
    ...
    public static class TextureResult {
        ...
        public TextureResult(MinecraftProfileTexture.Type type, MinecraftProfileTexture texture) {
            this.type = type;
